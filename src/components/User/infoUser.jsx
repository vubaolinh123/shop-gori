                        ...
                        <div className="">
                            <table className="overflow-auto  divide-y divide-gray-200 ">
                                <thead className="bg-gray-50">
                                    <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">MÃ ĐH</th>
                                ...
                                { info && info.map((bill, index) => (
                                    <tbody key={ bill._id } className="bg-white divide-y divide-gray-200">
                                        <tr>
                                            ...
                                            <td className="px-4 py-2 whitespace-nowrap "><span className="text-blue-500 bg-blue-300 font-bold px-[5px] py-[2px]"> { bill.status === 0 ? "Chờ Xác Nhân" : bill.status === 1 ? "Đang Vận Chuyển" : bill.status === 2 ? "Giao thành công" : bill.status === 3 ? "Hủy Đơn" : "Đơn Bị Hủy" }</span></td>
